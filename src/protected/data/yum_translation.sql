...
('Manage Profile Field', 'Manage Profil Field', 'de', 'yum'),
('Manage Profile Field', 'Administrar Campo del Perfil', 'es', 'yum'),
('Manage Profile Field', 'Gestione campo profilo', 'it', 'yum'),
...
('Admin sent messages', 'Verzonden admin berichten', 'nl', 'yum'),
('Admin users', 'Admin gebruikers', 'nl', 'yum'),
('Admin users can not be deleted!', 'Admin gebruikers kunnen niet worden verwijderd!', 'nl', 'yum'),
('Allow profile comments', 'Profiel berichten toestaan', 'nl', 'yum'),
('Allowed are lowercase letters and digits.', 'Slechts kleine letters en cijfers zijn toegestaan.', 'nl', 'yum'),
...
('Browse users', 'Doorzoek gebruikersgroepen', 'nl', 'yum'),
('Cancel', 'Annuleren', 'nl', 'yum'),
('Cancel deletion', 'Verwijdering annuleren', 'nl', 'yum'),
('Cannot set password. Try again.', 'Wachtwoord kan niet worden ingesteld. Probeer het opnieuw.', 'nl', 'yum'),
('Change admin Password', 'Wijzig admin wachtwoord', 'nl', 'yum'),
('Change password', 'Wijzig wachtwoord', 'nl', 'yum'),
('Changes', 'Wijzigingen', 'nl', 'yum'),
('Changes are saved', 'Wijzigingen zijn toegepast', 'nl', 'yum'),
...
('Create Role', 'Maak de rol', 'nl', 'yum'),
('Create User', 'Gebruiker aanmaken', 'nl', 'yum'),
('Create new Usergroup', 'Maak nieuwe gebruikersgroep', 'nl', 'yum'),
('Create new action', 'Nieuwe actie', 'nl', 'yum'),
('Create new field group', 'Maak nieuwe veldgroep', 'nl', 'yum'),
('Create new role', 'Maak nieuwe rol', 'nl', 'yum'),
('Create new settings profile', 'Maak een nieuw instellings profiel', 'nl', 'yum'),
('Create new user', 'Maak nieuwe gebruiker', 'nl', 'yum'),
('Create profile field', 'Profiel veld aanmaken', 'nl', 'yum'),
('Create profile fields group', 'Profiel veldgroup aanmaken', 'nl', 'yum'),
('Create role', 'Maak rol', 'nl', 'yum'),
('Create user', 'Gebruiker aanmaken', 'nl', 'yum'),
('Date', 'Datum', 'nl', 'yum'),
('Default', 'Standaard', 'nl', 'yum'),
('Delete Account', 'Account verwijderen', 'nl', 'yum'),
('Delete User', 'Gebruiker verwijderen', 'nl', 'yum'),
('Delete account', 'Account verwijderen', 'nl', 'yum'),
('Delete message', 'Bericht verwijderen', 'nl', 'yum'),
('Deny', 'weigeren', 'nl', 'yum'),
('Description', 'Omschrijving', 'nl', 'yum'),
('Different users logged in today', 'Verschillende gebruikers ingelogd vandaag', 'nl', 'yum'),
('Different view Profiles', 'Verschillende view profielen', 'nl', 'yum'),
('Display order of fields.', 'Volgorde van velden weergeven.', 'nl', 'yum'),
('Display order of group.', 'Volgorde van groepen weergeven.', 'nl', 'yum'),
('E-Mail address', 'E-Mail adres', 'nl', 'yum'),
('E-Mail already in use. If you have not registered before, please contact our System administrator.', 'E-Mail al in gebruik. Als u nog niet van te voren hebt geregistreren, neem dan contact op met onze systeembeheerder.', 'nl', 'yum'),
('E-mail', 'E-Mail', 'nl', 'yum'),
('Edit', 'Wijzig', 'nl', 'yum'),
('Edit personal data', 'Wijzig persoonlijke data', 'nl', 'yum'),
('Edit profile', 'Wijzig profiel', 'nl', 'yum'),
('Edit profile field', 'Wijzig profielveld', 'nl', 'yum'),
('Edit this role', 'Wijzig deze rol', 'nl', 'yum'),
('Email is incorrect.', 'E-Mail is niet juist', 'nl', 'yum'),
('Email is not set when trying to send Registration Email', 'E-Mail is niet ingesteld bij het verzenden van de registratie E-Mail', 'nl', 'yum'),
('Enable Captcha', 'Captcha inschakelen', 'nl', 'yum'),
('Enable Email Activation', 'E-Mail activatie inschakelen', 'nl', 'yum'),
('Enable Profile History', 'Profiel geschiedenis inschakelen', 'nl', 'yum'),
('Enable Recovery', 'Herstel inschakelen', 'nl', 'yum'),
('Enable Registration', 'Registratie inschakelen', 'nl', 'yum'),
('Error Message', 'Fout melding', 'nl', 'yum'),
('Error message when Validation fails.', 'Fout melding wanneer validatie mislukt.', 'nl', 'yum'),
('Field', 'Veld', 'nl', 'yum'),
('Field Size', 'Veldgrootte', 'nl', 'yum'),
('Field Size min', 'Minimale veldgrootte', 'nl', 'yum'),
('Field Type', 'Veldtype', 'nl', 'yum'),
('Field group', 'Veldgroep', 'nl', 'yum'),
('Field name on the language of &quot;sourceLanguage&quot;.', 'Veldnaam op de standaard taal', 'nl', 'yum'),
('Field size', 'Veldgrootte', 'nl', 'yum'),
('Field size in the database.', 'Veldgrootte in de databank', 'nl', 'yum'),
('Field type', 'Veldtype', 'nl', 'yum'),
('First name', 'Voornaam', 'nl', 'yum'),
('For all', 'Voor alle', 'nl', 'yum'),
('Form validation error', 'Form validatiefout', 'nl', 'yum'),
('Friends', 'Vrienden', 'nl', 'yum'),
('Friendship', 'Vriendschap', 'nl', 'yum'),
('Friendship confirmed', 'Vriendschap geaccepteerd', 'nl', 'yum'),
('Friendship request already sent', 'Vriendschaps verzoek is al verzonden', 'nl', 'yum'),
('Friendship request for {username} has been sent', 'Vriendschaps verzoek voor {username} is verzonden', 'nl', 'yum'),
('Friendship request has been rejected', 'Vriendschaps verzoek is afgewezen', 'nl', 'yum'),
('From', 'Van', 'nl', 'yum'),
('Generate Demo Data', 'Genereer Demo Data', 'nl', 'yum'),
('Go to profile of {username}', 'Ga naar profiel van {username} ', 'nl', 'yum'),
('Grant permission', 'Toestemming geven', 'nl', 'yum'),
('Group Name', 'Groepsnaam', 'nl', 'yum'),
('Group name on the language of "sourceLanguage".', 'Groepsnaam op de taal van "sourceLanguage"', 'nl', 'yum'),
('Group owner', 'Groepseigenaar', 'nl', 'yum'),
('Group title', 'Groepstitel', 'nl', 'yum'),
('Hidden', 'Verborgen', 'nl', 'yum'),
('Ignore', 'Negeer', 'nl', 'yum'),
('Ignored users', 'Negeer gebruikers', 'nl', 'yum'),
('Inactive users', 'Inactieve gebruikers', 'nl', 'yum'),
('Incorrect activation URL', 'Incorrecte activatie URL', 'nl', 'yum'),
('Incorrect activation URL.', 'Incorrecte activatie URL.', 'nl', 'yum'),
('Incorrect password (minimal length 4 symbols).', 'Wachtwoord incorrect (minimale lengte 4 symbolen)', 'nl', 'yum'),
('Incorrect recovery link.', 'Herstel link incorrect', 'nl', 'yum'),
('Incorrect symbols. (A-z0-9)', 'Symbolen incorrect. (A-z0-9)', 'nl', 'yum'),
('Incorrect username (length between 3 and 20 characters).', 'Gebruikersnaam incorrect (lengte tussen 3 en 20 karakters)', 'nl', 'yum'),
('Instructions have been sent to you. Please check your email.', 'Instructies zijn verstuurd. Bekijk uw mail alstublieft.', 'nl', 'yum'),
('Invitation', 'Uitnodiging', 'nl', 'yum'),
('Language', 'Taal', 'nl', 'yum'),
('Last name', 'Achternaam', 'nl', 'yum'),
('Last visit', 'Laatst bezocht', 'nl', 'yum'),
('Letters are not case-sensitive.', 'Letters zijn niet hoofdletter gevoelig.', 'nl', 'yum'),
...
('Manage Profile Fields', 'Beheer Profiel velden', 'nl', 'yum'),
('Manage Profiles', 'Beheer Profielen', 'nl', 'yum'),
('Manage Roles', 'Beheer Rollen', 'nl', 'yum'),
('Manage User', 'Beheer Gebruiker', 'nl', 'yum'),
('Manage Users', 'Beheer Gebruikers', 'nl', 'yum'),
('Manage field groups', 'Beheer veld groepen', 'nl', 'yum'),
('Manage friends', 'Beheer vrienden', 'nl', 'yum'),
('Manage my users', 'Beheer mijn gebruikers', 'nl', 'yum'),
('Manage profile Fields', 'Beheer profiel velden', 'nl', 'yum'),
('Manage profile field groups', 'Beheer profiel velden', 'nl', 'yum'),
('Manage profiles', 'Beheer profielen', 'nl', 'yum'),
('Manage roles', 'Beheer rollen', 'nl', 'yum'),
('Manage text settings', 'Beheer tekst instellingen', 'nl', 'yum'),
('Manage this profile', 'Beheer dit profiel', 'nl', 'yum'),
('Manage user Groups', 'Beheer gebruikersgroepen', 'nl', 'yum'),
('Manage users', 'Beheer gebruikers', 'nl', 'yum'),
('Manage Profile Field', 'M Profiel Veld', 'nl', 'yum'),
('Match', 'Match', 'nl', 'yum'),
('Message', 'Bericht ', 'nl', 'yum'),
('Message from', 'Bericht van', 'nl', 'yum'),
('Messages', 'Berichten', 'nl', 'yum'),
('Messaging system', 'Bericht systeem', 'nl', 'yum'),
('Minimal password length 4 symbols.', 'Minimale wachtwoord lengte 4 symbolen', 'nl', 'yum'),
('Module settings', 'Module instellingen', 'nl', 'yum'),
('Module text settings', 'Module tekst instellingen', 'nl', 'yum'),
('My Inbox', 'Mijn Inbox', 'nl', 'yum'),
('My friends', 'Mijn vrienden', 'nl', 'yum'),
('My groups', 'Mijn groepen', 'nl', 'yum'),
('My inbox', 'Mijn inbox', 'nl', 'yum'),
('My profile', 'Mijn profiel', 'nl', 'yum'),
('New friendship request', 'Nieuw vriendschapsverzoek', 'nl', 'yum'),
('New friendship requests', 'Nieuwe vriendschapsverzoeken', 'nl', 'yum'),
('New password is saved.', 'Nieuw wachtwoord is opgeslagen', 'nl', 'yum'),
('New profile comment', 'Nieuw profiel bericht', 'nl', 'yum'),
('New settings profile', 'Nieuwe instellingen profiel', 'nl', 'yum'),
('New value', 'Nieuwe waarde', 'nl', 'yum'),
('No', 'Nee', 'nl', 'yum'),
('No friendship requested', 'Geen vriendschapsverzoek aangevraagd', 'nl', 'yum'),
('No profile changes were made', 'Geen profiel aanpassingen zijn gemaakt', 'nl', 'yum'),
('No, but show on registration form', 'Nee, maar toon op registratie formulier', 'nl', 'yum'),
('Nobody has visited your profile yet', 'Nog niemand heeft je profiel bezocht', 'nl', 'yum'),
('None', 'Geen', 'nl', 'yum'),
('Not active', 'Niet actief', 'nl', 'yum'),
('Not assigned', 'Niet toegewezen', 'nl', 'yum'),
('Ok', 'Akkoord', 'nl', 'yum'),
('Old value', 'Oude waarde', 'nl', 'yum'),
('One of the recipients ({username}) has ignored you. Message will not be sent!', 'Een van de ontvangers ({username}) heeft jou genegeerd. Bericht zal niet verzonden worden', 'nl', 'yum'),
('Only owner', 'Alleen eigenaar', 'nl', 'yum'),
('Other', 'Andere', 'nl', 'yum'),
('Other Validator', 'Andere Validator', 'nl', 'yum'),
('Password', 'Wachtwoord', 'nl', 'yum'),
('Password Expiration Time', 'Wachtwoord Verloop Tijd', 'nl', 'yum'),
('Password is incorrect.', 'Wachtwoord is incorrect', 'nl', 'yum'),
('Password recovery', 'Wachtwoord herstellen', 'nl', 'yum'),
('Passwords do not match', 'Wachtwoorden komen niet overeen', 'nl', 'yum'),
('Permissions', 'Toestemmingen', 'nl', 'yum'),
('Please check your email. An instructions was sent to your email address.', 'Bekijk uw mail, een instructie is verzonden naar uw e-mail adres.', 'nl', 'yum'),
('Please check your email. Instructions have been sent to your email address.', 'Bekijk uw mail, instructies zijn verzonden naar uw e-mail adres.', 'nl', 'yum'),
('Please enter a request Message up to 255 characters', 'Toets een verzoek bericht in tot aan 255 karakters', 'nl', 'yum'),
...
('Please enter your login or email address.', 'Toets uw login of e-mail adres in.', 'nl', 'yum'),
...
('Please verify your E-Mail address', 'Verifieer uw e-mail adres', 'nl', 'yum'),
('Position', 'Positie', 'nl', 'yum'),
('Predefined values (example: 1, 2, 3, 4, 5,).', 'Vooraf gedefinieerde waardes (voorbeeld: 1, 2, 3, 4, 5,).', 'nl', 'yum'),
('Preserve Profiles', 'Bewaar profielen', 'nl', 'yum'),
('Privacy', 'Privacy ', 'nl', 'yum'),
('Privacy settings', 'Privacy instellingen', 'nl', 'yum'),
('Privacy settings for {username}', 'Privacy instellingen voor {username}', 'nl', 'yum'),
('Privacysettings', 'Privacyinstellingen', 'nl', 'yum'),
('Profile', 'Profiel', 'nl', 'yum'),
('Profile Comments', 'Profiel Berichten', 'nl', 'yum'),
('Profile Fields', 'Profiel Velden', 'nl', 'yum'),
('Profile field groups', 'Profiel veld groepen', 'nl', 'yum'),
('Profile field {fieldname}', 'Profiel  veld {username}', 'nl', 'yum'),
('Profile fields', 'Profiel velden', 'nl', 'yum'),
('Profile fields groups', 'Profiel velden groepen', 'nl', 'yum'),
('Profile history', 'Profiel geschiedenis', 'nl', 'yum'),
('Profile number', 'Profiel nummer', 'nl', 'yum'),
('Profile of', 'Profiel van', 'nl', 'yum'),
('Profiles', 'Profielen', 'nl', 'yum'),
('Range', 'Bereik', 'nl', 'yum'),
('Read Only Profiles', 'Alleen lezen profielen', 'nl', 'yum'),
('Receive a Email for new Friendship request', 'Ontvang een e-mail voor een nieuw Vriendschaps verzoek', 'nl', 'yum'),
('Receive a Email when a new profile comment was made', 'Ontvang een e-mail wanneer een nieuw profiel bericht is gemaakt', 'nl', 'yum'),
('Receive a Email when new Message arrives', 'Ontvang een e-mail wanneer een nieuw bericht is ontvangen', 'nl', 'yum'),
('Registered users', 'Geregistreerde gebruikers', 'nl', 'yum'),
...
('Reply', 'Antwoord', 'nl', 'yum'),
('Reply to Message', 'Beantwoord Bericht', 'nl', 'yum'),
('Reply to message', 'Beantwoord bericht', 'nl', 'yum'),
...
('Administration', 'Administratie', 'nl', 'yum'),
('Upload avatar for admin', 'Upload avatar voor admin', 'nl', 'yum'),
('Roles', 'Rollen', 'nl', 'yum'),
('Save', 'Opslaan', 'nl', 'yum'),
('Select multiple recipients by holding the CTRL key', 'Selecteer meerdere ontvangers doormiddel van de CTRL toets in te houden', 'nl', 'yum'),
('Send', 'Verstuur ', 'nl', 'yum'),
('Send a message to this User', 'Verstuur een bericht naar deze Gebruiker', 'nl', 'yum'),
('Send invitation', 'Verstuur uitnodiging', 'nl', 'yum'),
('Send message notifier emails', 'Verstuur bericht informerer e-mails', 'nl', 'yum'),
('Sent at', 'Verstuur op', 'nl', 'yum'),
('Sent messages', 'Verstuur berichten', 'nl', 'yum'),
('Separate usernames with comma to ignore specified users', 'Scheid gebruikersnamen met een comma om gespecifeerde gebruikers te negeren', 'nl', 'yum'),
('Settings', 'Instellingen ', 'nl', 'yum'),
('Settings profiles', 'Instellingen profielen', 'nl', 'yum'),
('Show administration Hierarchy', 'Toon administratie Hiërarchie', 'nl', 'yum'),
('Show friends', 'Toon vrienden', 'nl', 'yum'),
('Show permissions', 'Toon toestemmingen', 'nl', 'yum'),
('Show profile visits', 'Toon  profiel bezoeken', 'nl', 'yum'),
('Show roles', 'Toon rollen', 'nl', 'yum'),
('Show users', 'Toon gebruikers', 'nl', 'yum'),
('Statistics', 'Statestieken', 'nl', 'yum'),
('Status', 'Status', 'nl', 'yum'),
('Street', 'Straat', 'nl', 'yum'),
('Success', 'Succes', 'nl', 'yum'),
('Superuser', 'Supergebruiker', 'nl', 'yum'),
('Text Email Activation', 'Tekst e-mail Activatie', 'nl', 'yum'),
('Text Email Recovery', 'Tekst e-mail Herstel', 'nl', 'yum'),
('Text Email Registration', 'Tekst e-mail Registratie', 'nl', 'yum'),
('Text Login Footer', 'Tekst Login Footer', 'nl', 'yum'),
('Text Login Header', 'Tekst Login Header', 'nl', 'yum'),
('Text Registration Footer', 'Tekst Registratie Footer', 'nl', 'yum'),
('Text Registration Header', 'Tekst Registratie Header', 'nl', 'yum'),
('Text for new friendship request', 'Tekst voor nieuw vriendschap verzoek', 'nl', 'yum'),
('Text for new profile comment', 'Tekst voor nieuw profiel comment', 'nl', 'yum'),
('Thank you for your registration. Please check your email.', 'Dankuwel voor uw registratie. Bekijk alstublieft uw mail.', 'nl', 'yum'),
('The comment has been saved', 'Het bericht is opgeslagen', 'nl', 'yum'),
('The file "{file}" is not an image.', 'Het bestand "[file}" is geen afbeelding.', 'nl', 'yum'),
('The image "{file}" height should be "{height}px".', 'Het bestand "[file}" hoogte moet "{height}px" zijn.', 'nl', 'yum'),
('The image "{file}" width should be "{width}px".', 'Het bestand "[file}" breedte moet "{width}px" zijn.', 'nl', 'yum'),
('The image should have at least 50px and a maximum of 200px in width and height. Supported filetypes are .jpg, .gif and .png', 'Deze afbeelding moet tenminste 50px and een maximum van 200px in breedte en hoogte hebben. Geondersteunde bestandstypes zijn .jpg, .gif en .png', 'nl', 'yum'),
('The messages for your application language are not defined.', 'The berichten voor jouw applicatie taal zijn niet gedefinieerd.', 'nl', 'yum'),
('The minimum value of the field (form validator).', 'Het minimum waarde van het veld (form validator).', 'nl', 'yum'),
('The new password has been saved.', 'Het nieuwe wachtwoord is opgeslagen.', 'nl', 'yum'),
('The value of the default field (database).', 'De waarde van het standaard veld (database).', 'nl', 'yum'),
('There are a total of {messages} messages in your System.', 'Er zijn een totaal van {messages} berichten in uw Systeem.', 'nl', 'yum'),
('There are {active_users} active and {inactive_users} inactive users in your System, from which {admin_users} are Administrators.', 'Er zijn {active_users} actief en {inactive_users} niet actieve gebruikers in uw Systeem, waarvan {admin_users} Administrators zijn.', 'nl', 'yum'),
('There are {profiles} profiles in your System. These consist of {profile_fields} profile fields in {profile_field_groups} profile field groups', 'Er zijn {profiles} profielen in uw Systeem. Deze bestaan uit {profile_fields} profiel velden in {profile_field_groups} profiel veld groepen.', 'nl', 'yum'),
('There are {roles} roles in your System.', 'Er zijn {roles} rollen in uw Systeem.', 'nl', 'yum'),
('This account is blocked.', 'Dit account is geblokkeerd.', 'nl', 'yum'),
('This account is not activated.', 'Dit account is niet actief.', 'nl', 'yum'),
('This message will be sent to {username}', 'Dit bericht zal verzonden worden naar {username}', 'nl', 'yum'),
('This role can administer users of this roles', 'Deze Rol kan deze gebruikers administreren', 'nl', 'yum'),
('This user belongs to these roles:', 'Deze gebruiker behoort tot deze rollen:', 'nl', 'yum'),
('This user can administer this users', 'Deze gebruiker kan deze gebruikers administreren', 'nl', 'yum'),
('This user can administer this users:', 'Deze gebruiker kan deze gebruikers administreren:', 'nl', 'yum'),
('This user''s email adress already exists.', 'Dit gebruikers e-mail adres bestaat al.', 'nl', 'yum'),
('This user''s name already exists.', 'Deze gebruikersnaam bestaat al.', 'nl', 'yum'),
('This users have been assigned to this Role', 'Deze gebruikers zijn deze Rol toegewezen', 'nl', 'yum'),
('This users have been assigned to this role', 'Deze gebruikers zijn deze rol toegewezen', 'nl', 'yum'),
('This users have visited my profile', 'Deze gebruikers hebben mijn profiel bezocht', 'nl', 'yum'),
('Time sent', 'Tijd verstuurd', 'nl', 'yum'),
('Title', 'Titel', 'nl', 'yum'),
('To', 'Naar', 'nl', 'yum'),
('Try again', 'Probeer nogmaals', 'nl', 'yum'),
('Update', 'Update ', 'nl', 'yum'),
('Update Profile Field', 'Update Profiel Veld', 'nl', 'yum'),
('Update User', 'Update Gebruiker', 'nl', 'yum'),
('Update role', 'Update Rol', 'nl', 'yum'),
('Update user', 'Update gebruiker', 'nl', 'yum'),
('Upload Avatar', 'Upload Avatar', 'nl', 'yum'),
('Upload avatar', 'Upload avatar', 'nl', 'yum'),
('Upload avatar image', 'Upload avatar plaatje', 'nl', 'yum'),
('User', 'Gebruiker ', 'nl', 'yum'),
('User Administration', 'Gebruiker Administratie', 'nl', 'yum'),
('User Management Home', 'Gebruikersbeheer Thuis', 'nl', 'yum'),
('User Management settings configuration', 'Gebruikersbeheer instellingen configuratie', 'nl', 'yum'),
('User Operations', 'Gebruiker Operaties', 'nl', 'yum'),
('User activation', 'Gebruiker activatie', 'nl', 'yum'),
('User administration Panel', 'Gebruiker administratie Paneel ', 'nl', 'yum'),
('User administration panel', 'Gebruiker administratie paneel ', 'nl', 'yum'),
('User belongs to Roles', 'Gebruiker behoord tot Rollen', 'nl', 'yum'),
('User belongs to these roles', 'Gebruiker behoord tot deze rollen', 'nl', 'yum'),
('User can not administer any users', 'Gebruiker kan geen gebruikers administreren', 'nl', 'yum'),
('User can not administer any users of any role', 'Gebruiker kan geen gebruikers van geen enkele rol administreren', 'nl', 'yum'),
('User module settings', 'Gebruiker Module instellingen', 'nl', 'yum'),
('Usergroups', 'Gebruikergroepen', 'nl', 'yum'),
('Username', 'Gebruikersnaam', 'nl', 'yum'),
('Username is incorrect.', 'Gebruikersnaam is incorrect.', 'nl', 'yum'),
('Username or Email', 'Gebruikersnaam of e-mail', 'nl', 'yum'),
('Username or Password is incorrect', 'Gebruikersnaam of Wachtwoord is incorrect', 'nl', 'yum'),
('Users', 'Gebruikers', 'nl', 'yum'),
('Users:', 'Gebruikers:', 'nl', 'yum'),
('Variable name', 'Variabel naam', 'nl', 'yum'),
('Verification code', 'Verificatie code', 'nl', 'yum'),
('View', 'Bekijk', 'nl', 'yum'),
('View User', 'Bekijk Gebruiker', 'nl', 'yum'),
('View admin messages', 'Bekijk admin berichten', 'nl', 'yum'),
('View my messages', 'Bekijk mijn berichten', 'nl', 'yum'),
('View user "{username}"', 'Bekijk gebruiker "{username}"', 'nl', 'yum'),
('View users', 'Bekijk gebruikers', 'nl', 'yum'),
('Visible', 'Zichtbaar', 'nl', 'yum'),
('Write a comment', 'Schrijf een bericht', 'nl', 'yum'),
('Write a message', 'Schrijf een bericht', 'nl', 'yum'),
('Write a message to this User', 'Schrijf een bericht naar deze Gebruiker', 'nl', 'yum'),
('Write another message', 'Schrijf nog een bericht', 'nl', 'yum'),
('Write comment', 'Schrijf bericht', 'nl', 'yum'),
('Written at', 'Geschreven op', 'nl', 'yum'),
('Written from', 'Geschreven van', 'nl', 'yum'),
('Wrong password confirmation! Account was not deleted', 'Verkeerde wachtwoord bevestiging! Account is niet verwijderd', 'nl', 'yum'),
('Yes', 'Ja', 'nl', 'yum'),
('Yes and show on registration form', 'Ja en toon op registratie formulier', 'nl', 'yum'),
('You account is activated.', 'Uw account is geactiveerd', 'nl', 'yum'),
('You account is active.', 'Uw account is actief', 'nl', 'yum'),
('You already are friends', 'Uw bent al vrienden', 'nl', 'yum'),
('You are not allowed to view this profile.', 'U heeft geen toestemming om dit profiel te zien', 'nl', 'yum'),
('You are running the Yii User Management Module {version} in Debug Mode!', 'U draait momenteel het Yii Gebruiker Management Module {version} in Debug Modus!', 'nl', 'yum'),
('You do not have any friends yet', 'U hebt nog geen vrienden', 'nl', 'yum'),
('You do not have set an avatar image yet', 'U heeft nog geen avatar afbeelding', 'nl', 'yum'),
('You have new Messages !', 'U heeft nieuwe Berichten !', 'nl', 'yum'),
('You have new messages!', 'U heeft nieuwe berichten!', 'nl', 'yum'),
('You have {count} new Messages !', 'U heeft {count} nieuwe Berichten !', 'nl', 'yum'),
('Your Avatar image', 'Uw Avatar afbeelding', 'nl', 'yum'),
('Your Message has been sent.', 'Uw Bericht is verzonden', 'nl', 'yum'),
('Your account has been activated.', 'Uw account is geactiveerd', 'nl', 'yum'),
('Your account has been activated. Thank you for your registration.', 'Uw account is geactiveerd. Dankuwel voor uw registratie.', 'nl', 'yum'),
('Your changes have been saved', 'Uw aanpassingen zijn opgeslagen', 'nl', 'yum'),
('Your message has been sent', 'Uw bericht is verzonden', 'nl', 'yum'),
('Your new password has been saved.', 'Uw nieuwe wachtwoord is opgeslagen', 'nl', 'yum'),
('Your password has expired. Please enter your new Password below:', 'Uw wachtwoord is verlopen. Voer hieronder een nieuw wachtwoord in:', 'nl', 'yum'),
('Your profile', 'Uw profiel', 'nl', 'yum'),
('Your registration didn''t work. Please try another E-Mail address. If this problem persists, please contact our System Administrator.', 'Uw registratie is niet gelukt. Probeer een ander e-mail adres. Als het probleem blijft voorkomen neem dan contact op met de Systeem Administrator.', 'nl', 'yum'),
('Your request succeeded. Please enter below your new password:', 'Uw verzoek is geslaagd. Voer uw nieuwe wachtwoord onder in:', 'nl', 'yum'),
('activation key', 'activatie code', 'nl', 'yum'),
('change Password', 'wijzig Wachtwoord', 'nl', 'yum'),
('change password', 'wijzig wachtwoord', 'nl', 'yum'),
('email', 'E-Mail', 'nl', 'yum'),
('email address', 'E-Mail adres', 'nl', 'yum'),
('friends only', 'Alleen vrienden', 'nl', 'yum'),
('password', 'wachtwoord', 'nl', 'yum'),
('private', 'privé', 'nl', 'yum'),
('protected', 'beschermd', 'nl', 'yum'),
('public', 'publiek', 'nl', 'yum'),
('timestamp', 'timestamp', 'nl', 'yum'),
('username', 'gebruikersnaam', 'nl', 'yum'),
('username or email', 'gebruikersnaam of E-Mail', 'nl', 'yum'),
('{attribute} is too long (max. {num} characters).', '{attribute} is te lang (max. {num} karakters).', 'nl', 'yum'),
('{attribute} is too short (min. {num} characters).', '{attribute} is te kort (min. {num} karakters).', 'nl', 'yum'),
('{attribute} must include at least {num} digits.', '{attribute} moet tenminste {num} cijfers bevatten.', 'nl', 'yum'),
('{attribute} must include at least {num} lower case letters.', '{attribute} moet tenminste  {num} kleine letters bevatten.', 'nl', 'yum'),
('{attribute} must include at least {num} symbols.', '{attribute} moet tenminste {num} symbolen bevatten.', 'nl', 'yum'),
('{attribute} must include at least {num} upper case letters.', '{attribute} moet tenminste  {num} hoofd letters bevatten.', 'nl', 'yum'),
('{attribute} must not contain more than {num} sequentially repeated characters.', '{attribute} mag niet meer dan {num} herhaalde caracters bevatten.', 'nl', 'yum'),
('{attribute} must not contain whitespace.', '{attribute} mag geen spatie bevatten.', 'nl', 'yum'),
('Access control', 'toegangscontrole', 'nl', 'yum'),
('Activated', 'Geactiveerd', 'nl', 'yum'),
('Active - First visit', 'Actief - Eerste bezoek', 'nl', 'yum'),
('All', 'allemaal', 'nl', 'yum'),
('Allowed lowercase letters and digits.', 'Toegestaan kleine letters en cijfers', 'nl', 'yum'),
('An error occured while uploading your avatar image', 'Een fout is opgetreden tijdens het uploaden van uw avatar afbeelding', 'nl', 'yum'),
('Answer', 'Antwoord', 'nl', 'yum'),
('Appear in search', 'Verschijnen in zoek opdracht', 'nl', 'yum'),
('Are you sure you want to remove this friend?', 'Weet u zeker dat je deze vriend wil verwijderen?', 'nl', 'yum'),
('Assign this role to new users automatically', 'Deze rol automatisch toewijzen aan nieuwe gebruikers', 'nl', 'yum'),
('Browse', 'Bekijken', 'nl', 'yum'),
('Browse memberships', 'Lidmaatschappen bekijken', 'nl', 'yum'),
('Browse user activities', 'Gebruiker activiteiten bekijken', 'nl', 'yum'),
('Browse usergroups', 'Gebruikersgroepen bekijken', 'nl', 'yum'),
('Cancel request', 'Annuleer verzoek', 'nl', 'yum'),
('Category', 'Categorie', 'nl', 'yum'),
('Change Password', 'Verander wachtwoord', 'nl', 'yum'),
('Compose', 'Samenstellen', 'nl', 'yum'),
('Content', 'Inhoud', 'nl', 'yum'),
('Create Action', 'Creëer Actie', 'nl', 'yum'),
('Create Usergroup', 'Creëer Gebruikersgroep', 'nl', 'yum'),
('Create my profile', 'Creëer mijn profiel', 'nl', 'yum'),
('Create new Translation', 'Creëer nieuwe vertaling', 'nl', 'yum'),
('Create new User', 'Creëer nieuwe gebruiker', 'nl', 'yum'),
('Create new payment type', 'Creëer nieuwe betaal type', 'nl', 'yum'),
('Create new usergroup', 'Creëer nieuwe gebruikersgroep', 'nl', 'yum'),
('Create payment type', 'Creëer betaal type', 'nl', 'yum'),
('Delete Profile Field', 'Verwijder Profiel Veld', 'nl', 'yum'),
('Delete file', 'Verwijder bestand', 'nl', 'yum'),
('Deleted', 'Verwijderd ', 'nl', 'yum'),
('Different viewn Profiles', 'Ander profiel view', 'nl', 'yum'),
('Do not appear in search', 'Treed niet op in zoek', 'nl', 'yum'),
('Do not show my online status', 'Toon mijn online status niet', 'nl', 'yum'),
('Do not show the owner of a profile when i visit him', 'Laat de eigenaar van een profiel niet getoont worden als ik hem bezoek', 'nl', 'yum'),
('Duration in days', 'Duur in dagen', 'nl', 'yum'),
('Edit text', 'Wijzig tekst', 'nl', 'yum'),
('End date', 'Einddatum', 'nl', 'yum'),
('Ends at', 'Eindigt op', 'nl', 'yum'),
('Error message when you validate the form.', 'Foutmelding wanneer je het formulier valideerd', 'nl', 'yum'),
('Error while processing new avatar image : {error_message}; File was uploaded without resizing', 'Fout tijdens verwerking van nieuw avatar plaats : {error_message}; Bestand was geüpload zonder de grootte aantepassen.', 'nl', 'yum'),
('Expired', 'Verlopen', 'nl', 'yum'),
('Field size column in the database.', 'Veld grootte kolom in het database', 'nl', 'yum'),
('Field type column in the database.', 'Veld type kolom in het database', 'nl', 'yum'),
('Fields with <span class="required">*</span> are required.', 'Velden met <span class="required">*</span> zijn vereist.', 'nl', 'yum'),
('First Name', 'Voornaam', 'nl', 'yum'),
('Friends of {username}', 'Vrienden van {username}', 'nl', 'yum'),
('Friendship rejected', 'Vriendschap afgewezen', 'nl', 'yum'),
('General', 'Algemeen', 'nl', 'yum'),
('Having', 'Met', 'nl', 'yum'),
('How expensive is a membership?', 'Hoe duur is een lidmaatschap?', 'nl', 'yum'),
('How many days will the membership be valid after payment?', 'Hoeveel dagen is de lidmaatschap geldig na de betaling.', 'nl', 'yum'),
('Incorrect symbol''s. (A-z0-9)', 'incorrecte symbolen. (A-z0-9)', 'nl', 'yum'),
('Invalid recovery key', 'Ongeldige herstel sleutel', 'nl', 'yum'),
('Is membership possible', 'Is lidmaatschap mogelijk', 'nl', 'yum'),
('Join group', 'Lid worden van groep', 'nl', 'yum'),
('Jump to profile', 'Spring naar profiel', 'nl', 'yum'),
('Let me appear in the search', 'Laat mij optreden in de zoek opdracht', 'nl', 'yum'),
('Let the user choose in privacy settings', 'Laat de gebruiker het kiezen in de privacy instellingen', 'nl', 'yum'),
('List Profile Field', 'Lijst Profiel Veld', 'nl', 'yum'),
('List User', 'Lijst Gebruiker', 'nl', 'yum'),
...
('Manage permissions', 'Beheer toestemmingen', 'nl', 'yum'),
('Manage profile fields', 'Beheer profiel velden', 'nl', 'yum'),
('Manage profile fields groups', 'Beheer profiel velden groepen', 'nl', 'yum'),
('Mark as read', 'Markeer als gelezen', 'nl', 'yum'),
('Membership', 'Lidmaatschap', 'nl', 'yum'),
('Membership ends at: {date}', 'Lidmaatschap stopt op: {date}', 'nl', 'yum'),
('Membership has not been payed yet', 'Lidmaatschap is nog niet betaald', 'nl', 'yum'),
('Membership payed at: {date}', 'Lidmaatschap was betaald op {date}', 'nl', 'yum'),
('Memberships', 'Lidmaatschappen', 'nl', 'yum'),
('Message "{message}" has been sent to {to}', 'Bericht "{message}" is nog niet verzonden naar {to} ', 'nl', 'yum'),
('Message "{message}" was marked as read', 'Bericht "{message}" is gemarkeerd als gelezen', 'nl', 'yum'),
('Message count', 'Aantal berichten', 'nl', 'yum'),
('Message from ', 'Bericht van', 'nl', 'yum'),
('My memberships', 'Mijn lidmaatschappen', 'nl', 'yum'),
('Name',  'Naam',  'nl',  'yum'),
('New friendship request from {username}', 'Nieuw vriendschapsverzoek van {username}', 'nl', 'yum'),
('New messages', 'Nieuwe berichten', 'nl', 'yum'),
('New password', 'Nieuw wachtwoord', 'nl', 'yum'),
('New profile comment from {username}', 'Nieuw profiel bericht van {username}', 'nl', 'yum'),
('New translation', 'Nieuwe vertaling', 'nl', 'yum'),
('No new messages', 'Geen nieuwe berichten', 'nl', 'yum'),
('Nobody has commented your profile yet', 'Nog niemand heeft een bericht geplaatst op uw profiel', 'nl', 'yum'),
('Not visited', 'Niet bezocht', 'nl', 'yum'),
('Not yet payed', 'Nog niet betaald', 'nl', 'yum'),
('Only your friends are shown here', 'Alleen uw vrienden worden getoont hier', 'nl', 'yum'),
('Order confirmed', 'Bestelling bevestigd', 'nl', 'yum'),
('Order date', 'Bestellings datum', 'nl', 'yum'),
('Order membership', 'Bestelling Lidmaatschap', 'nl', 'yum'),
('Order number', 'Bestellings nummer', 'nl', 'yum'),
('Ordered at', 'Besteld op ', 'nl', 'yum'),
('Ordered memberships', 'Bestelde lidmaatschappen', 'nl', 'yum'),
('Participant count', 'Aantal deelnemers', 'nl', 'yum'),
('Participants', 'Deelnemers', 'nl', 'yum'),
('Payment', 'Betaling ', 'nl', 'yum'),
('Payment arrived', 'Betaling ontvangen', 'nl', 'yum'),
('Payment date', 'Betaling datum', 'nl', 'yum'),
('Payment types', 'Betaling types', 'nl', 'yum'),
('Payments', 'Betalingen', 'nl', 'yum'),
('Please activate you account go to {activation_url}', 'Activeer uw account ga naar {activation_url}', 'nl', 'yum'),
('Please enter your login or email addres.', 'Toets uw login of e-mail adres in.', 'nl', 'yum'),
('Please enter your user name or email address.', 'Toets uw gebruikersnaam of e-mail adres in.', 'nl', 'yum'),
('Predefined values (example: 1, 2, 3, 4, 5;).', 'Vooraf gedefinieerde waardes (voorbeeld: 1, 2, 3, 4, 5;).', 'nl', 'yum'),
('Preseve Profiles', 'Bewaar profielen', 'nl', 'yum'),
('Price', 'Prijs', 'nl', 'yum'),
('Profile field public options', 'Profiel veld openbare opties', 'nl', 'yum'),
('Profile of ', 'Profiel van', 'nl', 'yum'),
('Profile visits', 'Profiel bezoeken', 'nl', 'yum'),
('Regular expression (example: ''/^[A-Za-z0-9s,]+$/u'').', 'Normale uitdrukking (voorbeeld: ''/^[A-Za-z0-9s,]+$/u'').', 'nl', 'yum'),
('Remove', 'Verwijder', 'nl', 'yum'),
('Required field (form validator).', 'Vereist veld (formuliar validator).', 'nl', 'yum'),
('Retype Password', 'Bevestig Wachtwoord', 'nl', 'yum'),
('Retype Password is incorrect.', 'Bevestiging Wachtwoord is onjuist', 'nl', 'yum'),
('Retype your new password', 'Bevestig uw nieuwe wachtwoord', 'nl', 'yum'),
('Retyped password is incorrect', 'Bevestigde wachtwoord is incorrect', 'nl', 'yum'),
('Roles / Access control', 'Rollen / Toegang besturing', 'nl', 'yum'),
('Save payment type', 'Bewaar betaal type', 'nl', 'yum'),
('Save profile changes', 'Bewaar profiel aanpassingen', 'nl', 'yum'),
('Save role', 'Bewaar rol', 'nl', 'yum'),
('Search for username', 'Zoek voor gebruikersnamen', 'nl', 'yum'),
('Searchable', 'Zoekbaar', 'nl', 'yum'),
('Select a month', 'Selecteer een maand', 'nl', 'yum'),
('Select the fields that should be public', 'Selecteer de velden die openbaar moeten zijn', 'nl', 'yum'),
('Selectable on registration', 'Selecteerbaar bij registratie', 'nl', 'yum'),
('Set payment date to today', 'Zet betalings datum op vandaag', 'nl', 'yum'),
('Show activities', 'Toon activiteiten', 'nl', 'yum'),
('Show all', 'Toon alles', 'nl', 'yum'),
('Show my online status to everyone', 'Toon mijn online status aan iedereen', 'nl', 'yum'),
('Show online status', 'Toon online status', 'nl', 'yum'),
('Show the owner when i visit his profile', 'Toon de gebruiker wanneer ik zijn profiel bezoek', 'nl', 'yum'),
('Subject', 'Onderwerp', 'nl', 'yum'),
('Text translations', 'Tekst vertalingen', 'nl', 'yum'),
('Thank you for your registration. Contact Admin to activate your account.', 'dankuwel voor uw registratie. Neem contact op met de Admin om uw account te activeren', 'nl', 'yum'),
('Thank you for your registration. Please check your email or login.', 'dankuwel voor uw registratie. Bekijk uw e-mail of login.', 'nl', 'yum'),
('Thank you for your registration. Please {{login}}.', 'dankuwel voor uw registratie. {{login}}.', 'nl', 'yum'),
('The friendship request has been sent', 'De vriendschapsverzoek is verzonden.', 'nl', 'yum'),
('The image has been resized to {max_pixel}px width successfully', 'Het plaatje is met succes aangepast naar {max_pixel}px breedt', 'nl', 'yum'),
('The image was uploaded successfully', 'Het plaatje is met succes geüpload', 'nl', 'yum'),
('The new password has been saved', 'Het nieuwe wachtwoord is opgeslagen', 'nl', 'yum'),
('There was an error saving the password', 'Er was een fout tijdens het opslaan van het wachtwoord', 'nl', 'yum'),
('This membership is still {days} days active', 'Dit lidmaatschap is nog actief voor {days}', 'nl', 'yum'),
('This user can administrate this users', 'Deze gebruiker kan deze gebruikers administreren', 'nl', 'yum'),
('This user''s email address already exists.', 'Deze gebruiker zijn e-mail adres bestaat al.', 'nl', 'yum'),
('This users have a ordered memberships of this role', 'Deze gebruikers hebben lidmaastschap voor deze rollen besteld', 'nl', 'yum'),
('This users have commented your profile recently', 'Deze gebruikers hebben onlangs een bericht geplaatst op uw profiel ', 'nl', 'yum'),
('This users have visited your profile recently', 'Deze gebruikers hebben onlangs uw profiel bezocht', 'nl', 'yum'),
('Time left', 'Tijd over', 'nl', 'yum'),
('Translation', 'Vertaling', 'nl', 'yum'),
('Translations have been saved', 'Vertalingen zijn opgeslagen', 'nl', 'yum'),
('Update my profile', 'Update mijn profiel', 'nl', 'yum'),
('Update payment', 'Update betaling', 'nl', 'yum'),
('Upload avatar Image', 'Upload avatar Plaatje', 'nl', 'yum'),
('Use my Gravatar', 'Gebruik mijn Gravatar', 'nl', 'yum'),
('User is Online!', 'Gebruiker is Online!', 'nl', 'yum'),
('Username or email', 'Gebruikersnaam of e-mail', 'nl', 'yum'),
('Users: ', 'Gebruikers:', 'nl', 'yum'),
('Verification Code', 'Verificatiecode', 'nl', 'yum'),
('View Details', 'Bekijk Details', 'nl', 'yum'),
('View Profile Field', 'Bekijk Profiel Veld', 'nl', 'yum'),
('View Profile Field #', 'Bekijk Profiel Veld #', 'nl', 'yum'),
('Visit profile', 'Bezoek profiel', 'nl', 'yum'),
('When selecting searchable, users of this role can be searched in the "user Browse" function', 'Als Zoekbaar is geselecteerd, kunnen gebruikers van deze rol gezocht worden in het "Bekijk gebruikers" functie', 'nl', 'yum'),
('Write a message to {username}', 'Schrijf een bericht naar {username}', 'nl', 'yum'),
('Write message', 'Schrijf bericht', 'nl', 'yum'),
('You account is blocked.', 'Uw account is geblokeerd', 'nl', 'yum'),
('You account is not activated.', 'Uw account is niet geactiveerd', 'nl', 'yum'),
('You have joined this group', 'U bent lid geworden van deze groep', 'nl', 'yum'),
('You have no messages yet', 'U heeft nog geen berichten', 'nl', 'yum'),
('You registered from {site_name}', 'U bent geregistreerd van {site_name}', 'nl', 'yum'),
('Your Account has been activated. Thank you for your registration', 'Uw Account is geactiveerd. Dankuwel voor uw registratie', 'nl', 'yum'),
('Your Account has been activated. Thank you for your registration.', 'Uw Account is geactiveerd. Dankuwel voor uw registratie.', 'nl', 'yum'),
('Your account has been activated. Thank you for your registration', 'Uw account is geactiveerd. Dankuwel voor uw registratie', 'nl', 'yum'),
('Your account has been deleted.', 'Uw account is verwijderd', 'nl', 'yum'),
('Your activation succeeded', 'Uw activatie is geslaagd', 'nl', 'yum'),
('Your current password', 'Uw huidige wachtwoord', 'nl', 'yum'),
('Your current password is not correct', 'Uw huidige wachtwoord is niet correct', 'nl', 'yum'),
('Your friendship request has been accepted', 'Uw vriendschapsverzoek is geaccepteerd', 'nl', 'yum'),
('Your privacy settings have been saved', 'Uw prvicay instellingen zijn opgeslagen', 'nl', 'yum'),
('Your registration didn''t work. Please try another E-Mail address. If this problem persists, please contact our System Administrator. ', 'Uw registratie is niet gelukt. Probeer een andere e-mail adres. Als het probleem blijft terugkomen neem dan contact onze Systeem Administrator. ', 'nl', 'yum'),
('about', 'over', 'nl', 'yum'),
('birthdate', 'geboortedatum', 'nl', 'yum'),
('birthday', 'geboortedag', 'nl', 'yum'),
('do not make my friends public', 'Maak mijn vrienden niet openbaar', 'nl', 'yum'),
('firstname', 'voornaam', 'nl', 'yum'),
('lastname', 'achternaam', 'nl', 'yum'),
('make my friends public', 'maak mijn vrienden openbaar', 'nl', 'yum'),
('no', 'nee', 'nl', 'yum'),
('of user', 'van gebruiker', 'nl', 'yum'),
('only to my friends', 'alleen naar mijn vrienden', 'nl', 'yum'),
('street', 'straat', 'nl', 'yum'),
('verifyPassword', 'verifieerWachtwoord', 'nl', 'yum'),
('yes', 'ja', 'nl', 'yum'),
('zipcode', 'postcode', 'nl', 'yum'),
('{days} D, {hours} H, {minutes} M', '{days} D, {hours} U, {minutes} M', 'nl', 'yum');
