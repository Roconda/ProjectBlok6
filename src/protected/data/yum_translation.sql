...
('E-Mail already in use. If you have not registered before, please contact our System administrator.', 'E-Mail al in gebruik. Als u nog nooit  heeft geprobeert te registreren, neem dan contact op met onze systeembeheerder.', 'nl', 'yum'),
...
('Error message when Validation fails.', 'Fout melding wanneer valdiatie mislukt.', 'nl', 'yum'),
('Field', 'Veld', 'nl', 'yum'),
...
('Field name on the language of "sourceLanguage".', 'Veldnaam op de taal van "sourceLanguage".', 'nl', 'yum'),
('Field size', 'Veldgrootte', 'nl', 'yum'),
('Field size in the database.', 'Veldgrootte in de databank', 'nl', 'yum'),
('Field type', 'Veldtype', 'nl', 'yum'),
('First name', 'Veldnaam op de taal van "sourceLanguage ".', 'nl', 'yum'),
...
('Friendship request already sent', 'Vriendschap verzoek is al verzonden', 'nl', 'yum'),
('Friendship request for {username} has been sent', 'Vriendschap verzoek voor {username} is verzonden', 'nl', 'yum'),
('Friendship request has been rejected', 'Vriendschap verzoek is afgewezen', 'nl', 'yum'),
('From', 'Van', 'nl', 'yum'),
...
('Incorrect activation URL.', 'Incorrecte activatie URL', 'nl', 'yum'),
('Incorrect password (minimal length 4 symbols).', 'Incorrecte wachtwoord (minimale lengte 4 symbolen)', 'nl', 'yum'),
('Incorrect recovery link.', 'Incorrecte herstel link', 'nl', 'yum'),
('Incorrect symbols. (A-z0-9)', 'Incorrecte symbolen. (A-z0-9)', 'nl', 'yum'),
('Incorrect username (length between 3 and 20 characters).', 'Incorrecte gebruikersnaam (lengte tussen 3 en 20 karakters)', 'nl', 'yum'),
('Instructions have been sent to you. Please check your email.', 'Instructies zijn verstuurd. bekijk uw mail.', 'nl', 'yum'),
...
('Manage profiles', 'Beheer profielen', 'nl', 'yum'),
('Manage roles', 'Beheer rollen', 'nl', 'yum'),
('Manage text settings', 'Beheer text instellingen', 'nl', 'yum'),
('Manage this profile', 'Beheer dit profiel', 'nl', 'yum'),
('Manage user Groups', 'Beheer gebruiker Groeps', 'nl', 'yum'),
('Manage users', 'Beheer gebruikers', 'nl', 'yum'),
('Mange Profile Field', 'Mange Profiel Veld', 'nl', 'yum'),
('Match', 'Match', 'nl', 'yum'),
...
('New friendship request', 'Nieuw vriendschap verzoek', 'nl', 'yum'),
('New friendship requests', 'Nieuwe vriendschap verzoeken', 'nl', 'yum'),
...
('No', 'Nee', 'nl', 'yum'),
('No friendship requested', 'Geen vriendschap verzocht', 'nl', 'yum'),
...
('Password recovery', 'Wachtwoord herstel', 'nl', 'yum'),
('Passwords do not match', 'Wachtwoord komt niet overeen', 'nl', 'yum'),
...
('Receive a Email for new Friendship request', 'Ontvang een e-mail voor een nieuw Vriendschap verzoek', 'nl', 'yum'),
...
('Required', 'Benodigt', 'nl', 'yum'),
('Restore', 'Herstel', 'nl', 'yum'),
('Retype password', 'Nogmaals wachtwoord', 'nl', 'yum'),
...
('You do not have set an avatar image yet', 'U heeft nog geen avatar plaatje', 'nl', 'yum'),
('You have new Messages !', 'U heeft nieuwe Berichten !', 'nl', 'yum'),
('You have new messages!', 'U heeft nieuwe berichten!', 'nl', 'yum'),
('You have {count} new Messages !', 'U heeft {count} nieuwe Berichten !', 'nl', 'yum'),
('Your Avatar image', 'Uw Avatar plaatje', 'nl', 'yum'),
...
('Your password has expired. Please enter your new Password below:', 'Uw wachtwoord is verlopen. Voer een nieuw wachtwoord onder in:', 'nl', 'yum'),
...
('change Password', 'wijzig Password', 'nl', 'yum'),
('change password', 'wijzig password', 'nl', 'yum'),
('email', 'E-Mail', 'nl', 'yum'),
('email address', 'E-Mail adres', 'nl', 'yum'),
('friends only', 'Alleen vrienden', 'nl', 'yum'),
('password', 'password', 'nl', 'yum'),
('private', 'prive', 'nl', 'yum'),
('protected', 'beschermt', 'nl', 'yum'),
('public', 'publiek', 'nl', 'yum'),
('timestamp', 'timestamp', 'nl', 'yum'),
('username', 'gebruikersnaam', 'nl', 'yum'),
('username or email', 'gebruikersnaam of E-Mail', 'nl', 'yum'),
('{attribute} is too long (max. {num} characters).', '{attribute} is te lang (max. {num} letters).', 'nl', 'yum'),
('{attribute} is too short (min. {num} characters).', '{attribute} is te kort (min. {num} letters).', 'nl', 'yum'),
...
('Access control', 'Toegangsbesturing', 'nl', 'yum'),
...
('An error occured while uploading your avatar image', 'Een fout is opgetreden tijdens het uploaden van uw avatar plaatje', 'nl', 'yum'),
('Answer', 'antwoord', 'nl', 'yum'),
('Appear in search', 'Optreden in zoek opdracht', 'nl', 'yum'),
...
('Create Action', 'Creëer Aktie', 'nl', 'yum'),
...
('End date', 'beëindig datum', 'nl', 'yum'),
...
('The friendship request has been sent', 'De vriendschaps verzoek is verzonden.', 'nl', 'yum'),
...
('Your friendship request has been accepted', 'Uw vriendschaps verzoek is geaccepteerd', 'nl', 'yum'),
...
('do not make my friends public', 'Maak mijjn vrienden niet openbaar', 'nl', 'yum'),
...
('street', 'straat', 'nl', 'yum'),
('verifyPassword', 'verifierWachtwoord', 'nl', 'yum'),
('yes', 'ja', 'nl', 'yum'),
('zipcode', 'postcode', 'nl', 'yum'),
('{days} D, {hours} H, {minutes} M', '{days} D, {hours} H, {minutes} M', 'nl', 'yum');
