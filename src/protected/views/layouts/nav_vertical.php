...
<div class="well">
	...
	if(!Yii::app()->user->isGuest) {
		...
		array_push($items, array('label'=>'Course offer', 'icon' => 'tags', 'url'=>array('/courseoffer'), 'visible' => yii::app()->user->can('courseoffer_read') || Yii::app()->user->isAdmin() ));
        ...
        array_push($items, array('label'=>'Enrolled', 'icon' => 'tasks', 'url'=>array('/enroll'), 'visible' => yii::app()->user->can('enroll_read') || Yii::app()->user->isAdmin() ));
        array_push($items, array('label'=>'Assigned', 'icon' => 'hand-right', 'url'=>array('/assign') ,'visible' => yii::app()->user->can('assign_read') || Yii::app()->user->isAdmin() ));
        array_push($items, array('label'=>'My Enrolls', 'icon' => 'tasks', 'url'=>array('/enroll'), 'visible' => yii::app()->user->can('enroll_read_own')));
        array_push($items, array('label'=>'My Assigns', 'icon' => 'hand-right', 'url'=>array('/assign') ,'visible' => yii::app()->user->can('assign_read_own')));
		array_push($items, array('label' => 'GebruikersAdministratie', 'visible' => yii::app()->user->can('user_admin') ));
		array_push($items, array('label'=>'User Management', 'icon' => 'user','url'=>array('/user/user/admin/'), 'visible' => Yii::app()->user->can('user_admin') || Yii::app()->user->isAdmin() ));
		array_push($items, '<hr>');
