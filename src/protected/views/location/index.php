...
<h1><?php echo Yii::t('location','Locations') ?></h1>
<hr />
...
$this->widget('bootstrap.widgets.TbMenu', array(
	'type'=>'pills',
	'items'=>array(
		array('label'=>Yii::t('main','Create'), 'icon'=>'icon-plus', 'url'=>Yii::app()->controller->createUrl('create'), 'linkOptions'=>array(), 'visible' => Yii::app()->user->can('location_create') || Yii::app()->user->isAdmin() ),
	...
	'columns'=>array(
       ...
       array(
			...
			'buttons' => array(
				...
				'update' => array(
					'label'=> 'Update',
					'visible' => 'Yii::app()->user->can("location_update") || Yii::app()->user->isAdmin()',
					'options'=>array(
				...
				'delete' => array(
					'label'=> 'Delete',
					'visible' => 'Yii::app()->user->can("location_delete") || Yii::app()->user->isAdmin()',
					'options'=>array(
